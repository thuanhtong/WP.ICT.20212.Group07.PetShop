...
<div class="card card-outline card-info">
	...
	<div class="card-footer">
		...
		<a class="btn btn-flat btn-default" href="?page=sub_category">Cancel</a>
	</div>
</div>
<script>
	...
	$(document).ready(function(){
		...
		$('#category-form').submit(function(e){
			...
			start_loader();
			$.ajax({
				url:_base_url_+"classes/AdminController.php?f=save_sub_category",
				...
				success:function(resp){
					if(typeof resp =='object' && resp.status == 'success'){
						location.href = "./?page=sub_category";
