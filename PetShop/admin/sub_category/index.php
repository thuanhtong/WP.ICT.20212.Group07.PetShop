...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="?page=sub_category/manage_sub_category" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span> Create New</a>
		</div>
	</div>
						...
						<tr>
							...
							<td align="center">
				                ...
				                <div class="dropdown-menu" role="menu">
				                    <a class="dropdown-item" href="?page=sub_category/manage_sub_category&id=<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> Edit</a>
...
<script>
	...
	function delete_category($id){
		start_loader();
		$.ajax({
			url:_base_url_+"classes/AdminController.php?f=delete_sub_category",
			method:"POST",
			data:{id: $id},
			dataType:"json",
			error:err=>{
